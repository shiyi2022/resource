...
Original file is located at
    https://colab.research.google.com/drive/1SZLbv6yJQZtiT6u-BBkMja_gV5959jE0
...
test_init_df = spark.read.json('test.json')
...
samples.coalesce(1).write.json("samples2.json")
